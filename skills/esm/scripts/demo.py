...
Basic demonstration script showing how to use esm.
...
def demonstrate():
    """Demonstrate basic esm usage."""
    return {
        "skill": "esm",
        "status": "available",
        "description": "Evolutionary Scale Modeling - protein language models",
        "note": "See SKILL.md and references/ for comprehensive documentation"
    }


def main():
    parser = argparse.ArgumentParser(description='esm demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
