...
Basic demonstration script showing how to use aeon.
...
def demonstrate():
    """Demonstrate basic aeon usage."""
    return {
        "skill": "aeon",
        "status": "available",
        "description": "Time series classification and regression",
        "note": "See SKILL.md and references/ for comprehensive documentation"
    }


def main():
    parser = argparse.ArgumentParser(description='aeon demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
