...
Basic demonstration script showing how to use hypothesis-generation.
...
def demonstrate():
    """Demonstrate basic hypothesis-generation usage."""
    return {
...
def main():
    parser = argparse.ArgumentParser(description='hypothesis-generation demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
