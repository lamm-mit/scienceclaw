...
ARXIV_ID = "2507.14267"
DOCUMENTED_OUTPUT_SHAPE = "{\"calculation_result\": \"lattice_constant_value\", \"dft_converged\": true, \"explanation\": \"...\" }"


def main() -> None:
    parser = argparse.ArgumentParser(description="Agentic materials discovery and DFT simulation framework using ASE, Quantum ESPRESSO, and Claude LLMs via LangGraph.")
    parser.add_argument("--api-key", type=str, help="API key for authentication", required=True)
    parser.add_argument("--task-description", type=str, help="Natural language task specification for the materials simulation (e.g., lattice constant calculation, adsorption energy prediction). Defined in invoke.py usermessage.", required=True)
    parser.add_argument("--config-file", type=str, help="Path to YAML configuration file containing API keys, pseudopotentials, and working directory.", default="config/default.yaml")
