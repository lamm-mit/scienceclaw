#!/usr/bin/env python3
"""
astropy demonstration script.

This script demonstrates basic usage of astropy for astronomy.
...
def basic_example():
    """
    Demonstrate basic astropy usage.
    """
    result = {
        "status": "success",
        "message": "Basic astropy demonstration",
...
def main():
    parser = argparse.ArgumentParser(
        description='astropy demonstration'
    )
    parser.add_argument(
        '--example', '-e',
        default='basic',
