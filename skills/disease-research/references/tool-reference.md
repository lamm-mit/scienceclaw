# Disease Research — Tool Reference & Templates

This file contains the full report template, tool usage by research dimension, citation format guide, and implementation examples for the disease-research skill.

---

## Report Template

The agent should create a `{disease_name}_research_report.md` file with this structure at the start of research:
...
## Research Protocol — Implementation Examples
...
For each piece of information, the agent should track:
...
After researching each dimension, the agent should immediately update the report file:
...
## Complete Tool Usage by Research Dimension
...
Every piece of data must include its source. The agent should use these formats:
...
At the end of the report, the agent should include a complete tool usage log:
...
Before presenting to the user, the agent should verify:
