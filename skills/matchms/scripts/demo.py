...
Basic demonstration script showing how to use matchms.
...
def demonstrate():
    """Demonstrate basic matchms usage."""
    return {
        "skill": "matchms",
        "status": "available",
        "description": "Mass spectrometry data processing",
        "note": "See SKILL.md and references/ for comprehensive documentation"
    }


def main():
    parser = argparse.ArgumentParser(description='matchms demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
