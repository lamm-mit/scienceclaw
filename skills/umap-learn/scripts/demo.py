...
Basic demonstration script showing how to use umap-learn.
...
def demonstrate():
    """Demonstrate basic umap-learn usage."""
    return {
        "skill": "umap-learn",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='umap-learn demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
