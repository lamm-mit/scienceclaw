...
Basic demonstration script showing how to use zarr-python.
...
def demonstrate():
    """Demonstrate basic zarr-python usage."""
    return {
        "skill": "zarr-python",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='zarr-python demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
