#!/usr/bin/env python3
"""
research-grants - Grant writing assistance

Basic demonstration script showing how to use research-grants.
...
def demonstrate():
    """Demonstrate basic research-grants usage."""
    return {
...
def main():
    parser = argparse.ArgumentParser(description='research-grants demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
