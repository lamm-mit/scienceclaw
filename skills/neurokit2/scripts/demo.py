...
Basic demonstration script showing how to use neurokit2.
...
def demonstrate():
    """Demonstrate basic neurokit2 usage."""
    return {
        "skill": "neurokit2",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='neurokit2 demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
