...
Examples:
  ...
  python molecular_properties.py --file molecules.sdf --output properties.csv
    ...
    parser.add_argument('--smiles', '-s', dest='smiles_flag', help='SMILES string (flag form)')
    ...
    # Accept --smiles flag as well as positional
    if not args.smiles and args.smiles_flag:
        args.smiles = args.smiles_flag
