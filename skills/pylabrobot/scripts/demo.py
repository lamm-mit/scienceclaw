...
Basic demonstration script showing how to use pylabrobot.
...
def demonstrate():
    """Demonstrate basic pylabrobot usage."""
    return {
        "skill": "pylabrobot",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='pylabrobot demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
