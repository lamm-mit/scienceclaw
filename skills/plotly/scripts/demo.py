#!/usr/bin/env python3
"""
plotly demonstration script.

This script demonstrates basic usage of plotly for interactive visualization.
...
def basic_example():
    """
    Demonstrate basic plotly usage.
    """
    result = {
        "status": "success",
        "message": "Basic plotly demonstration",
...
def main():
    parser = argparse.ArgumentParser(
        description='plotly demonstration'
    )
    parser.add_argument(
        '--example', '-e',
        default='basic',
