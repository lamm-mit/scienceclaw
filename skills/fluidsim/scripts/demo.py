...
Basic demonstration script showing how to use fluidsim.
...
def demonstrate():
    """Demonstrate basic fluidsim usage."""
    return {
        "skill": "fluidsim",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='fluidsim demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
