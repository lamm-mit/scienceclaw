#!/usr/bin/env python3
"""
anndata demonstration script.

This script demonstrates basic usage of anndata for annotated data matrices.
...
def basic_example():
    """
    Demonstrate basic anndata usage.
    """
    result = {
        "status": "success",
        "message": "Basic anndata demonstration",
...
def main():
    parser = argparse.ArgumentParser(
        description='anndata demonstration'
    )
    parser.add_argument(
        '--example', '-e',
        default='basic',
