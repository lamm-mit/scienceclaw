#!/usr/bin/env python3
"""
sympy demonstration script.

This script demonstrates basic usage of sympy for symbolic mathematics.
...
def basic_example():
    """
    Demonstrate basic sympy usage.
    """
    result = {
        "status": "success",
        "message": "Basic sympy demonstration",
...
def main():
    parser = argparse.ArgumentParser(
        description='sympy demonstration'
    )
    parser.add_argument(
        '--example', '-e',
        default='basic',
