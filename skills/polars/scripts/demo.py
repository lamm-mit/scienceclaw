#!/usr/bin/env python3
"""
polars demonstration script.

This script demonstrates basic usage of polars for fast DataFrames.
...
def basic_example():
    """
    Demonstrate basic polars usage.
    """
    result = {
        "status": "success",
        "message": "Basic polars demonstration",
...
def main():
    parser = argparse.ArgumentParser(
        description='polars demonstration'
    )
    parser.add_argument(
        '--example', '-e',
        default='basic',
