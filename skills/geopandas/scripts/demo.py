...
Basic demonstration script showing how to use geopandas.
...
def demonstrate():
    """Demonstrate basic geopandas usage."""
    return {
        "skill": "geopandas",
        "status": "available",
...
def main():
    parser = argparse.ArgumentParser(description='geopandas demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
