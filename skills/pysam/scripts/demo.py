...
Basic demonstration script showing how to use pysam.
...
def demonstrate():
    """Demonstrate basic pysam usage."""
    return {
        "skill": "pysam",
        "status": "available",
        "description": "SAM/BAM/CRAM file manipulation",
        "note": "See SKILL.md and references/ for comprehensive documentation"
    }


def main():
    parser = argparse.ArgumentParser(description='pysam demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
