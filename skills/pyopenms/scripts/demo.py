...
Basic demonstration script showing how to use pyopenms.
...
def demonstrate():
    """Demonstrate basic pyopenms usage."""
    return {
        "skill": "pyopenms",
        "status": "available",
        "description": "Mass spectrometry data analysis",
        "note": "See SKILL.md and references/ for comprehensive documentation"
    }


def main():
    parser = argparse.ArgumentParser(description='pyopenms demonstration')
    parser.add_argument(
        '--format', '-f',
        default='summary',
